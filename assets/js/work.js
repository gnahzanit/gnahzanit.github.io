...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function showContent(buttonId, contentId, sectionId) {
        ...
        buttons.forEach(button => {
            const img = button.querySelector('img');
            img.src = button.getAttribute('data-img'); // Reset button images
        });
        ...
        // Show the specified section within the content
        if (sectionId) {
            const section = document.getElementById(sectionId);
            if (section) {
                section.style.display = 'block'; // Ensure the section is visible
    ...
    function parseUrlAndNavigate() {
        ...
        if (hash) {
            ...
            switch(button) {
                case 'softwaredevelopment':
                    showContent('softwareDevelopmentBtn', 'softwareDevelopmentContent', section);
                    scrollToSectionWithOffset(section);
                    break;
                case 'uiux':
                    showContent('uiUxBtn', 'uiUxContent', section);
                    scrollToSectionWithOffset(section);
                    break;
                case 'games':
                    showContent('gamesBtn', 'gamesContent', section);
                    scrollToSectionWithOffset(section);
                    break;
                default:
                    // Handle default case if needed
            ...
            // No hash, show Software Development content by default
            showContent('softwareDevelopmentBtn', 'softwareDevelopmentContent', null);
        }
    }
